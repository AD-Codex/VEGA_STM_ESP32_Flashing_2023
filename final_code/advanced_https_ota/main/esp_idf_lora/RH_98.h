...
#include "freertos/semphr.h"//for interrupts
#include "esp_log.h"
...
#define RH_RF98_NUM_INTERRUPTS 3
#define ESP_INTR_FLAG_DEFAULT 0//for define interrupts 
...
#define RH_RF98_REG_27_PPM_CORRECTION                      0x27
#define RH_RF98_REG_28_FEI_MSB                             0x28
#define RH_RF98_REG_29_FEI_MID                             0x29
#define RH_RF98_REG_2A_FEI_LSB                             0x2a
#define RH_RF98_REG_2C_RSSI_WIDEBAND                       0x2c
#define RH_RF98_REG_31_DETECT_OPTIMIZ                      0x31
#define RH_RF98_REG_33_INVERT_IQ                           0x33
#define RH_RF98_REG_37_DETECTION_THRESHOLD                 0x37
#define RH_RF98_REG_39_SYNC_WORD                           0x39
...
#define RH_RF98_LOW_FREQUENCY_MODE                    0x08
...
#define RH_RF98_LNA_GAIN_G1                           0x20
#define RH_RF98_LNA_GAIN_G2                           0x40
#define RH_RF98_LNA_GAIN_G3                           0x60                
#define RH_RF98_LNA_GAIN_G4                           0x80
#define RH_RF98_LNA_GAIN_G5                           0xa0
#define RH_RF98_LNA_GAIN_G6                           0xc0
#define RH_RF98_LNA_BOOST_LF                          0x18
#define RH_RF98_LNA_BOOST_LF_DEFAULT                  0x00
#define RH_RF98_LNA_BOOST_HF                          0x03
#define RH_RF98_LNA_BOOST_HF_DEFAULT                  0x00
#define RH_RF98_LNA_BOOST_HF_150PC                    0x11
...
#define RH_RF98_BW                                    0xf0

#define RH_RF98_BW_7_8KHZ                             0x00
#define RH_RF98_BW_10_4KHZ                            0x10
#define RH_RF98_BW_15_6KHZ                            0x20
#define RH_RF98_BW_20_8KHZ                            0x30
#define RH_RF98_BW_31_25KHZ                           0x40
#define RH_RF98_BW_41_7KHZ                            0x50
#define RH_RF98_BW_62_5KHZ                            0x60
#define RH_RF98_BW_125KHZ                             0x70
#define RH_RF98_BW_250KHZ                             0x80
#define RH_RF98_BW_500KHZ                             0x90
#define RH_RF98_CODING_RATE                           0x0e
#define RH_RF98_CODING_RATE_4_5                       0x02
#define RH_RF98_CODING_RATE_4_6                       0x04
#define RH_RF98_CODING_RATE_4_7                       0x06
#define RH_RF98_CODING_RATE_4_8                       0x08
#define RH_RF98_IMPLICIT_HEADER_MODE_ON               0x01
...
#define RH_RF98_PAYLOAD_CRC_ON                        0x04
#define RH_RF98_SYM_TIMEOUT_MSB                       0x03

// RH_RF98_REG_4B_TCXO                                0x4b
#define RH_RF98_TCXO_TCXO_INPUT_ON                    0x10
...
/////////////////////////////////////////////////////////////////////
/// \class RH_RF98 RH_RF98.h <RH_RF98.h>
...
/// \par Packet Format
///
/// All messages sent and received by this RH_RF98 Driver conform to this packet format:
///
/// - LoRa mode:
/// - 8 symbol PREAMBLE
...
/// \endcode
/// With these connections, you can then use the default constructor RH_RF98().
/// You can override the default settings for the SS pin and the interrupt in
/// the RH_RF98 constructor if you wish to connect the slave select SS to other
...
/// \code
/// rf98.setFrequency(915.0);
/// \endcode
/// which adds up to modifying sample sketches something like:
/// \code
/// #include <SPI.h>
/// #include <RH_RF98.h>
/// RH_RF98 rf98(5, 2); // Rocket Scream Mini Ultra Pro with the RFM95W
/// #define Serial SerialUSB
/// 
/// void setup() 
/// {
...
/// the example rf98_* sketches work without modification. Initialise the radio like
...
/// \par Interrupts
///
/// The RH_RF98 driver uses interrupts to react to events in the RFM module,
/// such as the reception of a new packet, or the completion of transmission
/// of a packet.  The RH_RF98 driver interrupt service routine reads status from
/// and writes data to the the RFM module via the SPI interface. It is very
/// important therefore, that if you are using the RH_RF98 driver with another
...
/// \par Memory
///
/// The RH_RF98 driver requires non-trivial amounts of memory. The sample
...
/// programs that use the RH_RF98 driver.
///
...
/// - rf98_client base station connected to a VHF discone antenna at 8m height above ground
/// - rf98_server mobile connected to 17.3cm 1/4 wavelength antenna at 1m height, no ground plane.
...
/// with the RH_RF98::setTxPower() function. The argument can be any of
...
class RH_RF98 : public lora_spi_driver
{
public:
    ...
    RH_RF98(uint8_t slaveSelectPin = 10, uint8_t interruptPin = 20,uint8_t MISOPin = 13,uint8_t MOSIPin = 11,uint8_t SCLKPin = 12);
    ...
    /// Sets the message preamble length in RH_RF98_REG_??_PREAMBLE_?SB
    ...
    /// register RH_RF98_REG_1D_MODEM_CONFIG1 is invalid, returns 0.
    int frequencyError();
...
protected:
    /// This is a low level function to handle the interrupts for one instance of RH_RF98.
...
private:
    ...
    /// Low level interrupt service routine for device connected to interrupt 1
    static void         isr2(void* arg);

    /// Array of instances connected to interrupts 0 and 1
    static RH_RF98*     _deviceForInterrupt[];
    ...
    uint8_t             _buf[RH_RF98_MAX_PAYLOAD_LEN];
...
/// @example rf98_client.pde
/// @example rf98_server.pde
/// @example rf98_encrypted_client.pde
/// @example rf98_encrypted_server.pde
/// @example rf98_reliable_datagram_client.pde
/// @example rf98_reliable_datagram_server.pde
