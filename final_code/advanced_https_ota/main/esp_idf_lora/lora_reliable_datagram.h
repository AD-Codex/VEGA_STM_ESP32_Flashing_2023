// lora_reliable_datagram.h
//
// Author: Mike McCauley (mikem@airspayce.com)
// Copyright (C) 2011 Mike McCauley
// $Id: lora_reliable_datagram.h,v 1.17 2016/04/04 01:40:12 mikem Exp $

#ifndef lora_reliable_datagram_h
#define lora_reliable_datagram_h
...
/////////////////////////////////////////////////////////////////////
/// \class lora_reliable_datagram lora_reliable_datagram.h <lora_reliable_datagram.h>
...
/// Based on RHDatagram, adds flags and sequence numbers. lora_reliable_datagram is reliable in the sense
...
///
/// You can use lora_reliable_datagram to send broadcast messages, with a TO address of RH_BROADCAST_ADDRESS,
...
///
/// lora_reliable_datagram and the underlying drivers always transmit as soon as
/// sendtoWait() is called.  lora_reliable_datagram waits for an acknowledgement,
...
///
/// There is no message queuing or threading in lora_reliable_datagram. 
...
///
class lora_reliable_datagram : public lora_datagram
{
public:
    /// Constructor. 
    /// \param[in] driver The RadioHead driver to use to transport messages.
    /// \param[in] thisAddress The address to assign to this node. Defaults to 0
    lora_reliable_datagram(lora_generic_driver& driver, uint8_t thisAddress = 0);
