...
#ifndef lora_spi_driver_h
#define lora_spi_driver_h
...
class lora_spi_driver : public lora_generic_driver
{
public:
    /// Constructor
    ...
    lora_spi_driver( uint8_t slaveSelectPin=10,uint8_t MISOPin=13,uint8_t MOSIPin=11,uint8_t SCLKPin=12,int SPIFrequency=2000000,uint8_t SPIMode=0);
