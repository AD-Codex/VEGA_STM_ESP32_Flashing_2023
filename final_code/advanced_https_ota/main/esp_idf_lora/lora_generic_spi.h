...
#ifndef lora_generic_spi_h
#define lora_generic_spi_h
...
public:
    ...
    lora_generic_spi(Frequency frequency = Frequency1MHz, BitOrder bitOrder = BitOrderMSBFirst, DataMode dataMode = DataMode0);
