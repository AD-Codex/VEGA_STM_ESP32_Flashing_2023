...
class lora_hardware_spi : public lora_generic_spi
{
...
public:
    ...
    lora_hardware_spi(Frequency frequency = Frequency1MHz, BitOrder bitOrder = BitOrderMSBFirst, DataMode dataMode = DataMode0);
...
extern lora_hardware_spi hardware_spi;
