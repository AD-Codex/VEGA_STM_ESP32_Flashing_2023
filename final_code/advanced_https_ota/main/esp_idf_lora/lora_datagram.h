...
// $Id: lora_datagram.h,v 1.14 2015/08/12 23:18:51 mikem Exp $

#ifndef lora_datagram_h
#define lora_datagram_h
...
/////////////////////////////////////////////////////////////////////
/// \class lora_datagram lora_datagram.h <lora_datagram.h>
/// \brief Manager class for addressed, unreliable messages
///
/// Every lora_datagram node has an 8 bit address (defaults to 0).
/// Addresses (DEST and SRC) are 8 bit integers with an address of RH_BROADCAST_ADDRESS (0xff) 
/// reserved for broadcast.
///
/// \par Media Access Strategy
///
/// lora_datagram and the underlying drivers always transmit as soon as sendto() is called.
///
/// \par Message Lengths
///
...
public:
    ...
    lora_datagram(lora_generic_driver& driver, uint8_t thisAddress = 0);
    ...
    /// to be accepted by all lora_datagram nodes within range.
